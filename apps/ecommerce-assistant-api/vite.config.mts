...
export default defineConfig({
  ...
  cacheDir: '../../node_modules/.vite/ecommerce-assistant-api',
  ...
  build: {
    outDir: '../../dist/ecommerce-assistant-api',
    emptyOutDir: true,
  ...
  test: {
    ...
    reporters: ['default'],
    coverage: {
      reportsDirectory: '../../coverage/ecommerce-assistant-api',
